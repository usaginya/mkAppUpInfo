...
(function(){
	...
	#wrapper div[class*=content-wrapper_],#wrapper div[class*=content-wrapper_] [class*=content-box_],
	 #wrapper div[class*=weather-top_]{background-image:none!important;background-color:#fff0!important}
	...
	.darkmode em,.darkmode.dark div[class*=button-list_] span[class*=label_],.darkmode.dark .op-weather-province-city,
	 .darkmode.dark [class*=error-tip],.darkmode.dark .markdownsdk-wrapper .md-highlight,
	 .darkmode.dark .dqa-code-span{color:#f77!important}
	...
	.darkmode.dark a:not([class*=op_weather]):not(.OP_LOG_LINK):not([class*=btn_]),.darkmode.dark h3[class*=title_],
	 .darkmode.dark .result-op [class*=pag-item_]:not([class*=active]),.darkmode.dark .sc-button.sc-sublink,.darkmode.dark .sc-button-new.sc-sublink,
	 ...
	 .darkmode.dark [class*=info-row-btn_],.darkmode.dark [class*=button_],.darkmode.dark [class*=item-word_],
	 .darkmode.dark [tpl=recommend_list_san] [class*=link_],.darkmode.dark [tpl=recommend_list_san] [class*=text-subtitle],
	 .darkmode.dark [class*=cos-more-link-text],.darkmode.dark [class*=cos-fold-switch-text]{color:#9db2ff!important}
	...
	.darkmode.dark a:hover:not([class*=op_weather]):not([class*=btn_]),.darkmode.dark #u>a:hover:not([name*=login]),
	 ...
	 .darkmode.dark [class*=card-more_]:hover [class*=card-more-link],
	 .darkmode.dark [tpl=recommend_list_san] [class*=link_]:hover{color:#c8f!important}
	...
	.darkmode.dark #foot,.darkmode.dark .sam_newgrid~#page,.darkmode.dark .x-interact-publish-cont,
	 ...
	 .darkmode.dark [class*=loc-wrapper_],.darkmode.dark [class*=episode-btn_],.darkmode.dark [class*=-tlinkur] a,
	 .darkmode.dark [class*=input-box_],.darkmode.dark [class*=desc-common_],.darkmode.dark [class*=query-btn],
	 .darkmode.dark [class*=query-wrapper_],.darkmode.dark [class*=orientation-title-wrapper_]{background:#2225!important}
	.darkmode.dark [class*=input-box_] [class*=input_]{background:#1115!important;border:1px solid #0000!important}
	...
	.darkmode.dark div[class*=calendar-box] div[class*=content-thead],.darkmode.dark .cosd-citation-list-content-title{color:#aaa!important}
	.darkmode.dark .cell-almanac,.darkmode.dark .result-molecule>#page a:hover,
	.darkmode.dark .cosd-citation-list a:hover .cosd-citation-list-content-title{color:#ddd!important}
	...
	.darkmode.dark .op_express_delivery_more li i,.darkmode.dark .op_express_delivery_hidemore,
	 .darkmode.dark .op_express_delivery_showmore,.darkmode.dark .cos-swiper-control-icon{color:#a7a7ff}
	...
	.darkmode.dark .search_tool:hover,.darkmode.dark .search_tool_conter span:hover,
	 ...
	 .darkmode.dark [class*=select-container],.darkmode.dark .cu-color-text,.darkmode.dark .markdownsdk-wrapper,
	 .darkmode.dark .cos-color-text,.darkmode.dark [data-pmd] .c-color-link{color:#bbb}
	...
	.darkmode.dark #wrapper [data-pmd] .c-img img,.darkmode.dark .x-interact-publish-opt>*:not(.send),.darkmode.dark .interact-bar-right,
	 ...
	 .darkmode.dark #wrapper .c-color .sub-icon,.darkmode.dark [class*=sc-audio-] [class*=-icon_],
	 .darkmode.dark [class*=sc-audio-][class*=-icon_]{filter:invert(1) hue-rotate(150deg)}
	...
	.darkmode.dark .c-container [class*=ask-doctor-btn]:not([class*=btn-]),
	 ...
	 .darkmode.dark .c-container [class*=btn-w]:not([class*=btn-]):not([class*=cos-row]),
	 .darkmode.dark .col-header .col-viewmore-wrap,.darkmode.dark [class*=share] [class*=btn_],
	 .darkmode.dark .cos-swiper-control-next,.darkmode.dark .cos-swiper-control-prev,.darkmode.dark .cosd-citation-list {background:#2228;color:#bbb}
	...
	.darkmode.dark .c-container [class*=ask-doctor-btn]:not([class*=btn-]):hover,
	 ...
	 .darkmode.dark .c-container [class*=btn-w]:not([class*=btn-]):not([class*=cos-row]):hover,
	 .darkmode.dark [class*=share] [class*=btn_]:hover,.darkmode.dark .cos-swiper-control-next:hover,
	 .darkmode.dark .cosd-citation-list a:hover,.darkmode.dark .cos-swiper-control-prev:hover{background:#1118!important;color:#a088ff!important}
	...
	.darkmode.dark .new-pmd .c-line-clamp1[class*=source-name_],.darkmode.dark .op_weather4_xlzstit,
	 .darkmode.dark .op_weather4_jslul span,.darkmode.dark [class*=color-span_] [class^=text_],.darkmode.dark [class*=btn_] a{color:#fff!important}
	...
	.darkmode.dark #wrapper [class*=episode-btn_]:hover,.darkmode.dark [class*=-tlinkur] a:hover,
	 .darkmode.dark [class*=query-btn]:hover{background:#111!important}
	...
	.darkmode.dark #wrapper [class^=_content] [class^=load_],.darkmode.dark [class*=more-btn-icon_]{background-color:#2225!important}
	.darkmode.dark #wrapper [class*=tabs-wrapper_] [class*=tab_],.darkmode.dark [class*=orientation-title_]{color:#aaa!important}
	...
	.darkmode.dark .dqa-code-block{background:#2225!important;border-color:#444!important}
	.darkmode.dark .dqa-code-span{background:#222c!important}
	.darkmode.dark .code-header{background:#2225!important}
	...
	.darkmode.dark .cos-fold-switch-mask{linear-gradient(#fff0 0, #0000 31%, var(--cos-color-bg-raised-inverse) 62%)!important}
	</style>`;
