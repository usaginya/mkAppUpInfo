...
DataManager.makeDir = function(filePath) {
    var fs = require('fs');
    const dirCache = {};
...
DataManager.writeDecryptDataBase = function(srcPath, json){
    var fs = require('fs');
    var dDataPath ='decrypt/' + srcPath;
    this.makeDir(dDataPath);
    fs.writeFileSync(dDataPath, json);
};

DataManager.writeDecryptMapData = function(maxId){
...
DataManager.loadDataFile = function(name, src) {
    ...
    xhr.onload = function() {
        if (xhr.status < 400) {
            DataManager.writeDecryptDataBase(url, xhr.responseText);
